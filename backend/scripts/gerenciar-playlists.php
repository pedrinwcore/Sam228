...
mysqli_query($conexao,"INSERT INTO playlists_videos (codigo_playlist,path_video,video,width,height,bitrate,duracao,duracao_segundos,tipo,ordem) VALUES ('".$dados_playlist["codigo"]."','".addslashes($path)."','".addslashes($video)."','".$width."','".$height."','".$bitrate."','".$duracao."','".$duracao_segundos."','".$tipo."','".$ordem."')") or die("Ooops! Ocorreu um erro no mysql: ".mysqli_error($conexao));
